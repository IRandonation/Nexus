    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="glass-modal w-[500px] max-w-[90vw] max-h-[80vh] overflow-y-auto"
        ...
        >
          ...
          <div className="p-4 space-y-4">
            <div>
              <label className="text-xs text-gray-400 mb-1 block">任务内容</label>
              <textarea
                value={editedTask.content}
                onChange={(e) =>
                  setEditedTask({ ...editedTask, content: e.target.value })
                }
                className="glass-input w-full bg-glass-highlight rounded px-3 py-2 text-sm min-h-[80px] resize-none"
              />
            </div>
          ...
          <div className="p-4 glass-divider-top flex gap-2">
            <button
              onClick={handleSave}
              className="flex-1 glass-button bg-glass-highlight hover:bg-glass-active border-glass-border flex items-center justify-center gap-2"
            >
              <Check size={16} />
              保存
            </button>
            <button
              ...
              className="glass-button text-gray-300 hover:text-white flex items-center gap-2"
            >
              <Trash2 size={16} />
              删除
            </button>
